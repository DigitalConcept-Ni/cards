let municipalIdCoding = {
    'BOACO': ['BOACO', 'CAMOAPA', 'SAN JOSE DE LOS REMATES', 'SAN LORENZO TEUSTEPE', 'SANTA LUCIA', 'TEUSTEPE'],
    ...
    'CHONTALES': ['EL AYOTE', 'MUELLE DE LOS BUEYES', 'ACOYAPA', 'COMALAPA', 'SAN FRANCISCO DE CUAPA', 'EL CORAL', 'JUIGALPA', 'EL RAMA', 'LA LIBERTAD', 'SAN PEDRO DE LOVAGO', 'SANTO DOMINGO', 'SANTO TOMAS', 'VILLA SANDINO', 'NUEVA GUINEA'],
    'RACCN': ['BONANZA', 'MULUKUKU', 'PRINZAPOLKA', 'PUERTO CABEZAS', 'ROSITA', 'SIUNA', 'WASPAN'],
    'RACCS': ['BLUEFIELDS', 'CORN ISLAND', 'DESEMBOCADURA DE RIO GRANDE', 'EL TORTUGUERO', 'KUKRA HILL', 'LA CRUZ DE RIO GRANDE', 'LAGUNA DE PERLAS', 'BOCANA DE PAIWAS'],
    'ESTELI': ['CONDEGA', 'ESTELI', 'LA TRINIDAD', 'PUEBLO NUEVO', 'SAN JUAN DE LIMAY', 'SAN NICOLAS'],
    'GRANADA': ['DIRIA', 'DIRIOMO', 'GRANADA', 'NANDAIME'],
    'JINOTEGA': ['EL CUA BOCAY', 'JINOTEGA', 'LA CONCORDIA', 'SAN JOSE DE BOCAY', 'SAN RAFAEL DEL NORTE', 'SAN SEBASTIAN DE YALI', 'SANTA MARIA DE PANTASMA', 'WIWILI-JINOTEGA'],
    ...
    'MATAGALPA': ['WASLALA', 'CIUDAD DARIO', 'EL TUMA-LA DALIA', 'ESQUIPULAS', 'MATAGALPA', 'MATIGUAS', 'MUY MUY', 'RANCHO GRANDE', 'RIO BLANCO', 'SAN DIONISIO', 'SAN ISIDRO', 'SAN RAMÓN', 'SEBACO', 'TERRABONA'],
